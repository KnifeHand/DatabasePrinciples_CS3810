...
INSERT INTO Actors (actorName, sex)
VALUES ('Keri Russell', 'F');
INSERT INTO Actors (actorName, sex)
VALUES ('Matthew Rhys', 'M');
INSERT INTO Actors (actorName, sex)
VALUES ('Andrew Lincoln', 'M');
INSERT INTO Actors (actorName, sex)
VALUES ('Jon Bernthal', 'M');
INSERT INTO Actors (actorName, sex)
VALUES ('Sarah Wayne Callies', 'F');
INSERT INTO Actors (actorName, sex)
VALUES ('Scott Speedman', 'M');
INSERT INTO Actors (actorName, sex)
VALUES ('Amy Jo Johnson', 'F');
INSERT INTO Actors (actorName, sex)
VALUES ('Tangi Miller', 'F');
INSERT INTO Actors (actorName, sex)
...
INSERT INTO Seasons
VALUES (1, 1, 'spring', 2013, 13);
INSERT INTO Seasons
VALUES (1, 2, 'spring', 2014, 13);
INSERT INTO Seasons
VALUES (1, 3, 'spring', 2015, 13);
INSERT INTO Seasons
VALUES (1, 4, 'spring', 2016, 13);
INSERT INTO Seasons
VALUES (1, 5, 'spring', 2017, 13);
INSERT INTO Seasons
VALUES (1, 6, 'spring', 2018, 10);
-- "The Walking Dead" seasons
INSERT INTO Seasons
VALUES (2, 1, 'fall', 2010, 6);
INSERT INTO Seasons
VALUES (2, 2, 'fall', 2011, 13);
INSERT INTO Seasons
VALUES (2, 3, 'fall', 2012, 16);
INSERT INTO Seasons
VALUES (2, 4, 'fall', 2013, 16);
INSERT INTO Seasons
VALUES (2, 5, 'fall', 2014, 16);
INSERT INTO Seasons
VALUES (2, 6, 'fall', 2015, 16);
INSERT INTO Seasons
VALUES (2, 7, 'fall', 2016, 16);
INSERT INTO Seasons
VALUES (2, 8, 'fall', 2017, 16);
INSERT INTO Seasons
VALUES (2, 9, 'fall', 2018, 16);
-- "Felicity" seasons
INSERT INTO Seasons
VALUES (3, 1, 'fall', 1998, 22);
INSERT INTO Seasons
VALUES (3, 2, 'fall', 1999, 23);
INSERT INTO Seasons
VALUES (3, 3, 'fall', 2000, 17);
INSERT INTO Seasons
VALUES (3, 4, 'fall', 2011, 22);
-- "Breaking Bad" seasons
INSERT INTO Seasons
VALUES (4, 1, 'spring', 2008, 7);
INSERT INTO Seasons
VALUES (4, 2, 'spring', 2009, 13);
INSERT INTO Seasons
VALUES (4, 3, 'spring', 2010, 13);
INSERT INTO Seasons
VALUES (4, 4, 'fall', 2011, 13);
INSERT INTO Seasons
VALUES (4, 5, 'fall', 2012, 8);
INSERT INTO Seasons
VALUES (4, 5, 'fall', 2013, 8);
...
Select COUNT(sex) AS 'total', sex AS 'sex'
from Actors
group by sex;
SELECT COUNT(males.sex)   as 'males',
       COUNT(females.sex) AS 'females';


-- query 04) return the names of the actors/actresses that were in 'The Americans' sorted by actorName
SELECT actorName
from Actors
INNER JOIN acts actors_series on Actors.actorId = actors_series.actorId
INNER JOIN Series S on actors_series.seriesId = S.seriesId
...
(select actorName from actors INNER JOIN acts actors_series on Actors.actorId = actors_series.actorId);
